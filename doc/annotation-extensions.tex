...
\newcommand{\jlsURL}{http://java.sun.com/docs/books/jls/se6/html/}
\urldef{\jlsEightEightFourURL}\url{http://java.sun.com/docs/books/jls/se6/html/classes.html#8.8.4}
\urldef{\jlsNineSixURL}\url{http://java.sun.com/docs/books/jls/se6/html/interfaces.html#9.6}
\urldef{\jlsInheritedURL}\url{https://docs.oracle.com/javase/specs/jls/se8/html/jls-9.html#jls-9.6.4.3}
\urldef{\jlsNineSevenURL}\url{http://java.sun.com/docs/books/jls/se6/html/interfaces.html#9.7}
\urldef{\jlsFifteenNine}\url{http://java.sun.com/docs/books/jls/se6/html/expressions.html#15.9}
\urldef{\jlsFifteenNineFiveOneURL}\url{http://java.sun.com/docs/books/jls/se6/html/expressions.html#15.9.5.1}
\urldef{\jlsFifteenTwelveFourFiveURL}\url{http://java.sun.com/docs/books/jls/se6/html/expressions.html#15.12.4.5}
...
the class file.  See
\myurl{https://bitbucket.org/typetools/jsr308-langtools/wiki/AnnotationsOnStatements} for a
...
\myurl{https://groups.google.com/forum/#!forum/jsr308-discuss}),
...
\subsection{Disjunctions\label{locations-disjunctions}}
...
\item
  ...
  including hierarchical data.  As the success of \ahref{http://www.w3.org/XML/}{XML}, \ahref{http://yaml.org/}{YAML}, and other such
...
\myurl{https://groups.google.com/forum/#!forum/jsr-305}.
...
(JLS \ahref{\jlsInheritedURL}{\S9.6.4.3})
...
(\myurl{https://checkerframework.org/}) works.
