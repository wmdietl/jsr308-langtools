...
those on the receiver, so they can be inferred from the annotations on the receiver.)
%
  Here is an example:
% \begin{itemize}
...
\item
  ...
  formal parameter.  This restricton does not limit expressiveness, because
