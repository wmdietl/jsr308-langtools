...
As a specal case, a type annotation (one meta-annotated with
...
\newline
  ...
  symbolic constant name adds the suffix \code{\_GENERIC\_OR\_ARRAY}.
...
\caption{\label{tbl:locations}
  ...
  fields.  We assume that each annotation is a type annotation.
...
% LocalWords:  fontsize pt NonNull getNeighbors const Readonly
