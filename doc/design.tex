...
It contains the
\ahref{http://checkerframework.org/jsr308/specification/java-annotation-design.html}{latest version}
% latest version
...
%HEVEA This document is available in PDF format at \myurl{http://checkerframework.org/jsr308/specification/java-annotation-design.pdf}.
...
% \ahref{http://checkerframework.org/jsr308/specification/jsr308.pdf}{JLS and JVMS changes}.
%
...
see \myurl{http://checkerframework.org/jsr308/current/jsr308-faq.html}.
...
(\myurl{http://checkerframework.org/}) is
...
\myurl{http://checkerframework.org/jsr308/}.  These checkers
...
(\myurl{http://checkerframework.org/})
...
% types'' (\myurl{http://checkerframework.org/jsr308/current/java-type-qualifiers.pdf}),
...
% (\myurl{http://checkerframework.org/annotation-file-utilities/annotation-file-format.pdf}), describes a
