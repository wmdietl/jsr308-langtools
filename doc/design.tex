...
permitted in Java SE 6 but are discarded by the compiler.
...
plug-in~\cite{JSR269} needs to read annotations when compiling a client of
the class file.
...
% LocalWords:  Nonnegative typedefs unabbrev reusability
