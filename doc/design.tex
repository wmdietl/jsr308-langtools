...
method \<this> refers to the receiver.)
...
\targetinfocontentspartial{a cast or a type argument in a constructor/method
  call/reference} contains ane \code{invocation\_type\_argument\_target} or
\code{method\_reference\_type\_argument}:
