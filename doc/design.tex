...
In a parameterized type, array, or nested class, there are multiple places that an
...
by the outer types, in order from innermost to outermost.
%
For an array
...
In this example, the entries for \<@A>, \<@E>, and \<I> are stored elsewhere in
...
Declaration: \code{@A O1.@B O2<@C S,@D T>.@E O3.@F Inner<@G U, @H V>}
