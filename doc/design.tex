...
% latest version
of this document and of the \ahref{http://types.cs.washington.edu/jsr308/specification/jsr308.pdf}{JLS and JVMS changes for JSR 308}, along
...
Specification.  That document is available at
\url{http://types.cs.washington.edu/jsr308/specification/jsr308.pdf} and
...
the class file format (Section~\ref{class-file}); it is primarily references to the \ahref{http://types.cs.washington.edu/jsr308/specification/jsr308.pdf}{JLS and JVMS changes}.
%
...
see \myurl{http://types.cs.washington.edu/jsr308/current/jsr308-faq.html}.
...
See the changes to the Java Language Specification in \url{http://types.cs.washington.edu/jsr308/specification/jsr308.pdf}.
...
See the changes to the Java Virtual Machine Specification in \url{http://types.cs.washington.edu/jsr308/specification/jsr308.pdf}.
...
\myurl{http://types.cs.washington.edu/jsr308/}.  These checkers
...
% types'' (\myurl{http://types.cs.washington.edu/jsr308/current/java-type-qualifiers.pdf}),
...
% LocalWords:  QualifiedType toArray localvar ReadWrite  2x5 308's
...
% LocalWords:  308's casted useE1 useE2 pack200 unpack200 
% LocalWords:  Mahmood theReceiver foo 
% LocalWords:  308's innerMethod 
% LocalWords:  308's multi classfiles MyType
