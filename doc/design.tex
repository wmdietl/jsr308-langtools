...
cast & \code{CAST}
& \code{0x86}, \code{0x87} & \S\ref{class-file:ext:ri:cast} \\
type test (\code{instanceof}) & \code{INSTANCEOF}
& \code{0x88}, \code{0x89} & \S\ref{class-file:ext:ri:cast} \\
object creation (\code{new}) & \code{NEW}
& \code{0x8A}, \code{0x8B} & \S\ref{class-file:ext:ri:cast} \\
...
lambda parameter type & \code{METHOD\_INVOCATION\_TYPE\_ARGUMENT}
& \code{0x8E}, \code{0x8F} & \S\ref{class-file:ext:ri:lambda-parameter} \\
type argument in method reference & \code{METHOD\_REFERENCE\_TYPE\_ARGUMENT}
& \code{0x8E}, \code{0x8F} & \S\ref{class-file:ext:ri:mref-typearg} \\
\hline
\end{tabular}
\end{center}
%BEGIN LATEX
...
\newline
  Enumeration elements marked \unused{} will never be generated from Java
  source code as of Java SE 8.  However, they may appear in the
  class file.
}
\end{figure}
...
% cast, see Section~\ref{class-file:ext:ri:cast}),
