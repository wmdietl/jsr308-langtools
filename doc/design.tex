...
\attributelocation{containing a \code{methodparam\_target}}{\code{method\_info} structure}
...
\attributelocation{containing a \code{exception\_target}}{\code{method\_info} structure}
...
\attributelocation{containing a \code{typearg\_target}}{\code{Code} attribute}
