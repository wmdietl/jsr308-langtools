 ...
 *
 * <p>The tool infrustrcutre will interact with classes extending this abstract
 * class as follows:
 *
 * <ol>
 * [Identical to {@link Processor} life cycle]
 *
 ...
 *
 * [Unique to {@code AbstractTypeProcessor} subclasses}
 *
 * <li>As appropriate, the tools calls the
 * {@link #process(TypeElement, TreePath) process} method on the
 * {@code Processor}.  The tool infrastructure needs to analyze the passed
 * class before the method invocation.  A separate invocation is made for each
 * analyzed and to-be-processed class.
 *
 * <li>The tools calls the {@link #processOver() processOver} method on the
 * {@code Processor} once all the classes of interest are processed.
 *
 * </ol>
 *
...
public abstract class AbstractTypeProcessor extends AbstractProcessor {
    ...
    private boolean hasInvokedProcessOver = false;
    ...
    private final class AttributionTaskListener implements TaskListener {
        ...
        public void finished(TaskEvent e) {
            ...
            if (!hasInvokedProcessOver && elements.isEmpty() && log.nerrors == 0) {
                processOver();
                hasInvokedProcessOver = true;
            }
